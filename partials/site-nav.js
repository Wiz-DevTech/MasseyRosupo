...
(function () {
  ...
  function inject(html) {
    ...
    var map = { 'entdash.html':'entity','litdash.html':'matters','securemaindash.html':'forms','orders-results.html':'orders','arbitration.html':'arbitration','my-account.html':'account' };
    var key = map[page];
    if (key) {
